      ...
      <section className="processing-template-details-v45">
        ...
        <div className="processing-template-fields-v45">
          <label>
            ...
            <HoverSelect value={prefs.defaultCapability || 'auto'} onChange={event => update('defaultCapability', event.target.value)}>
          ...
          <label>
            ...
            <HoverSelect value={prefs.targetLanguage || 'auto'} onChange={event => update('targetLanguage', event.target.value)}>
          ...
          <label>
            ...
            <HoverSelect value={prefs.defaultIndustry || 'auto'} onChange={event => update('defaultIndustry', event.target.value)}>
          ...
          <label>
            ...
            <HoverSelect value={prefs.bilingualLayout || 'auto'} onChange={event => update('bilingualLayout', event.target.value)}>
              <option value="auto">{L('AI 自动推荐', 'AI recommended', 'AI đề xuất')}</option>
          ...
          <label>
            ...
            <HoverSelect value={prefs.qualityMode || 'balanced'} onChange={event => update('qualityMode', event.target.value)}>
